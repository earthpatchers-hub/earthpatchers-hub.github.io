  ...
  const copy = {
    labels: {
      en: {
        ...
        smallIntro: "Small, clear missions you can do without searching through endless information. You save money, learn something useful, and yes, the planet gets a patch too.",
        ...
        sessionLengthFilter: "Duration",
        recurrenceFilter: "How Often",
        typeFilter: "Type",
        difficultyFilter: "How Hard",
        allSessionLengths: "Any duration",
        allRecurrences: "Any frequency",
        allTypes: "Any type",
        allDifficulties: "Any level",
        oneOff: "One-off",
      ...
      ro: {
        ...
        smallIntro: "Misiuni mici și clare, pe care le poți face fără să cauți prin informații nesfârșite. Economisești bani, înveți ceva util și da, și planeta primește un patch.",
        ...
        sessionLengthFilter: "Durată",
        recurrenceFilter: "Cât de des",
        typeFilter: "Tip",
        difficultyFilter: "Cât de greu",
        allSessionLengths: "Orice durată",
        allRecurrences: "Orice frecvență",
        allTypes: "Orice tip",
        allDifficulties: "Orice nivel",
    ...
    roSmall: {
      "button-wizard": { title: "Vrăjitorul Nasturilor", achievement: "Ucenicul Aței", summary: "Coase la loc un nasture lipsă sau slăbit pe o haină.", purpose: "Repară o haină în loc să o înlocuiești.", validation: "Trimite o poză înainte și după.", age: "4+ cu ajutor / 7+ singur", prep: ["ac", "ață", "nasture"], steps: ["Găsește un nasture slăbit sau lipsă", "Coase nasturele bine", "Verifică dacă ține"] },
      "lights-ninja": { title: "Ninja Luminilor", achievement: "Ninja la stins luminile", summary: "Stinge luminile când ieși din camere.", purpose: "Economisește energie și devino mai atent la consumul tău.", validation: "Verifică-te singur timp de 7 zile și trimite o confirmare pe email.", prep: ["Nu ai nevoie de pregătire specială."], steps: ["Stinge lumina când ieși dintr-o cameră", "Fă o verificare rapidă a luminilor seara", "Repetă timp de 7 zile"] },
      "toy-hospital": { title: "Spitalul Jucăriilor", achievement: "Doctor de Jucării", summary: "Repară o jucărie stricată în loc să o arunci.", purpose: "Învață să repari în loc să înlocuiești.", validation: "Trimite o poză înainte și după.", age: "3+ cu părinte", prep: ["bandă adezivă sau lipici"], steps: ["Găsește o jucărie stricată", "Repar-o", "Verifica dacă functioneaza"] },
      "sock-detective": { title: "Detectivul Șosetelor", achievement: "Detectiv de Rufe", summary: "Găsește și potrivește șosetele rămase singure după spălat.", purpose: "Eviți să cumperi șosete noi fără rost.", validation: "Trimite o poza cu perechile gasite.", prep: ["coș de rufe"], steps: ["Adună șosetele fără pereche", "Potrivește perechile", "Pune-le înapoi în sertar"] },
      "fridge-detective": { title: "Detectivul Frigiderului", achievement: "Exploratorul Frigiderului", summary: "Găsește alimente care ar trebui mâncate curând.", purpose: "Reduci risipa alimentară.", validation: "Trimite o poză cu alimentele alese.", prep: ["deschide frigiderul"], steps: ["Verifică frigiderul", "Alege 3 alimente care se vor strica curând", "Mută-le în față pentru a le folosi primele"] },
      "speedy-shower": { title: "Dușul Rapid", achievement: "Eroul dușului rapid", summary: "Fă dușuri de sub cinci minute.", purpose: "Economisește apă și energia folosită pentru încălzire.", validation: "Trimite o poză cu cronometrul sau verifică-te singur timp de 5 zile și trimite o confirmare pe email.", prep: ["cronometru"], steps: ["Pornește cronometrul", "Terminǎ dușul în sub 5 minute", "Repetă timp de 5 zile"] },
      "mini-cleanup": { title: "Mini Curățenie în Parc", achievement: "Ajutor de Cartier", summary: "Strânge cel puțin 10 gunoaie.", purpose: "Spații comune mai curate.", validation: "Trimite o poză cu gunoiul strâns.", age: "4+ cu adult", prep: ["mănuși", "sac de gunoi"], steps: ["Alege o zonă mică afară", "Strange 10 gunoaie", "Arunca-le corect la cosurile de gunoi"] },
      "plant-guardian": { title: "Micul Gardian al Plantelor", achievement: "Micul Grădinar", summary: "Plantează semințe sau o plantă mică.", purpose: "Încurajezi spațiile verzi și grija pentru lucrurile vii.", validation: "Trimite o poză cu ghiveciul plantat.", prep: ["ghiveci", "pământ", "semințe"], steps: ["Pregătește pământul", "Plantează semințele", "Udă semințele plantate"] },
      "donation-adventure": { title: "Aventura Donației", achievement: "Inimă Generoasă", summary: "Donează cinci obiecte încă bune de folosit.", purpose: "Îi ajuți pe alții și prelungești viața obiectelor.", validation: "Trimite o poză de la locul de donație.", age: "3+ cu părinții", prep: ["sac/punga pentru donații"], steps: ["Alege cinci obiecte utile", "Pune-le în sac/punga", "Du-le la centrul de donații sau doneaza direct unei persoane nevoiase"] },
      "book-traveler": { title: "Cartea Călătoare", achievement: "Dăruitor de Povești", summary: "Dă mai departe o carte citită.", purpose: "Încurajezi lectura și împărtasirea lucrurilor bune.", validation: "Trimite o poză cu schimbul de carte.", prep: ["carte"], steps: ["Alege o carte terminată", "Dă-o mai departe cuiva"] },
      "leftover-champion": { title: "Campionul Resturilor Bune", achievement: "Salvator de Mâncare", summary: "Mănâncă resturile de mancare înainte să gătești altceva.", purpose: "Reduci risipa de mâncare.", validation: "Trimite o poză cu masa pregătită din resturi..", prep: ["resturi de mâncare"], steps: ["Verifică frigiderul", "Mănâncă întâi resturile", "Repetă timp de 3 zile"] },
      "standby-scout": { title: "Cercetasul energiei irosite", achievement: "Cercetas de Energie", summary: "Găsește lucruri uitate în priză si opreste-le", purpose: "Reduci risipa de electricitate.", validation: "Trimite poze cu lucrurile scoase din priza sau oprite.", prep: ["plimbare prin casă"], steps: ["Găsește lucruri uitate în priză si opreste-le", "Întreabă un părinte dacă este in regula să le oprești", "Scoate din priza lucrurile aprobate"] }
    },
    roMedium: {
      "lunchbox-architect": { title: "Arhitectul Pachețelului", achievement: "Inginer de Gustări", summary: "Planifică și pregătește un pachețel de acasă folosind ce ai deja.", purpose: "Reduci ambalajele și înveți abilități de bază pentru pregătirea hranei.", validation: "Trimite o poză cu pachețelul final.", age: "5+ cu ajutor / 8+ singur", prep: ["cutie reutilizabilă pentru pachet", "ingrediente de acasă", "tocător", "cuțit (cu ajutor)"], steps: ["Uită-te în frigider și cămară", "Planifică un prânz simplu cu ingredientele disponibile", "Pregătește mâncarea", "Pune totul în cutii reutilizabile"] },
      "plant-care-apprentice": { title: "Ucenicul Îngrijirii Plantelor", achievement: "Șoptitorul Plantelor", summary: "Învață de ce are nevoie o plantă și îngrijește-o corect timp de o săptămână.", purpose: "Înțelegi că plante diferite au nevoie de îngrijire diferită.", validation: "Trimite o poză cu planta în ziua 1 și în ziua 7.", age: "4+ cu ajutor / 7+ singur", prep: ["plantă", "apă", "caiet sau telefon pentru a căuta informații despre plantă"], steps: ["Identifică specia plantei", "Caută ce nevoi de îngrijire are", "Ud-o sau îngrijește-o după aceste nevoi", "Observă cum se schimbă planta"] },
      "laundry-weather-wizard": { title: "Vrăjitorul Rufelor la Aer", achievement: "Powered by Wind", summary: "Usucă hainele la aer în loc să folosești uscătorul, ori de câte ori se poate.", purpose: "Economisești electricitate și prelungești viața hainelor.", validation: "Trimite o poză cu hainele puse la uscat pe suport sau pe sfoară.", age: "6+ cu ajutor / 9+ singur", prep: ["uscător de rufe sau sfoară", "haine spălate"], steps: ["Spală hainele normal", "Pune-le la uscat", "Observă dacă se usucă mai repede la soare sau la umbră"] },
      "fridge-organizer": { title: "Organizatorul Frigiderului", achievement: "Rezolvatorul Cazurilor Reci", summary: "Organizează un raft din frigider ca mâncarea să nu fie uitată.", purpose: "Reduci risipa alimentară și găsești mai ușor mâncarea.", validation: "Trimite o poză înainte și după a raftului din frigider.", age: "6+ cu ajutor / 9+ singur", prep: ["lavetă pentru curățat", "cutie sau tavă"], steps: ["Scoate lucrurile de pe un raft", "Curăță raftul", "Grupează alimentele similare", "Pune mâncarea mai veche în față"] },
      "bike-explorer": { title: "Exploratorul pe Bicicletă", achievement: "Călător pe Picioarele Lui", summary: "Înlocuiește o deplasare scurtă cu mașina prin mers pe jos sau cu bicicleta.", purpose: "Reduci poluarea și îți formezi obiceiuri sănătoase.", validation: "Trimite o poză cu tine pe bicicleta sau mergand pe jos.", age: "6+ cu ajutor / 12-16 singur, în funcție de părinți", prep: ["bicicletă sau pantofi de mers", "cască (dacă mergi cu bicicleta)"], steps: ["Alege o destinație apropiată", "Mergi acolo pe bicicletă sau pe jos", "Observă ce vezi în jurul tău"] },
      "recycling-sort-master": { title: "Maestrul Sortării pentru Reciclare", achievement: "Specialist în Sortare", summary: "Sortează corect un sac întreg de reciclare din casă.", purpose: "Înveți reciclarea corectă și eviți contaminarea.", validation: "Trimite o poză cu reciclarea sortată.", age: "6+ cu ajutor / 9+ singur", prep: ["sac cu reciclare", "containere de reciclare"], steps: ["Golește sacul de reciclare", "Separă hârtia", "Separă plasticul", "Separă metalul", "Separă sticla", "Pune-le în containerele corecte"] },
      "backpack-detective": { title: "Detectivul Ghiozdanului", achievement: "Exploratorul Genții", summary: "Verifică-ți ghiozdanul zilnic ca să nu uiți mâncare sau dezordine în el.", purpose: "Reduci risipa de mâncare și îți formezi obiceiuri de organizare.", validation: "Trimite o poză cu ghiozdanul curățat.", age: "5+ cu ajutor / 8+ singur", prep: ["ghiozdan"], steps: ["Golește geanta zilnic", "Scoate ambalajele și mâncarea rămasă", "Pune la loc lucrurile utile"] },
      "packaging-detective": { title: "Detectivul Ambalajelor", achievement: "Investigatorul Deșeurilor", summary: "Analizează ambalajele unor produse din casă și caută alternative mai bune.", purpose: "Îți ajuți familia să observe ambalajele inutile.", validation: "Trimite poze cu trei produse ambalate pe care le-ai analizat.", age: "6+ cu ajutor / 9+ singur", prep: ["produse ambalate din casă"], steps: ["Alege trei produse ambalate", "Examinează ambalajul", "Discută cum ar putea fi cumpărate cu mai puțin ambalaj"] },
      "repair-apprentice": { title: "Ucenicul Reparațiilor", achievement: "Ucenicul Reparațiilor", summary: "Învață cum să repari un obiect de zi cu zi.", purpose: "Încurajezi reparația în schimbul înlocuirii.", validation: "Trimite poze înainte și după.", age: "7+ cu ajutor / 10+ singur", prep: ["obiect de reparat", "unelte simple"], steps: ["Identifică problema", "Învață cum poate fi reparată", "Încearcă reparația"] },
      "garden-helper": { title: "Ajutorul din Grădină", achievement: "Gardianul Grădinii", summary: "Ajută la îngrijirea unei grădini sau a plantelor de afară.", purpose: "Te conectezi cu natura și înțelegi îngrijirea plantelor.", validation: "Trimite o poză cu munca făcută în grădină.", age: "5+ cu ajutor / 8+ singur", prep: ["stropitoare", "mănuși", "unelte mici"], steps: ["Udă plantele", "Scoate buruienile", "Curăță zona"] },
      "neighborhood-pathfinder": { title: "Căutătorul Drumurilor din Cartier", achievement: "Explorator Local", summary: "Explorează cartierul și identifică locuri utile din comunitate.", purpose: "Îi ajută pe copii să învețe despre comunitatea lor locală.", validation: "Trimite o poză cu unul dintre locurile descoperite.", age: "6+ cu ajutor / 9+ singur", prep: ["pantofi de mers"], steps: ["Plimbă-te prin zonă", "Găsește locuri utile (parc, bibliotecă, magazin)"] },
      "family-energy-audit": { title: "Auditul de Energie al Familiei", achievement: "Investigatorul Energiei", summary: "Inspectează casa și identifică risipa de energie.", purpose: "Îți ajuți familia să observe cum este folosită energia acasă.", validation: "Trimite poze cu trei îmbunătățiri făcute.", age: "7+ cu ajutor / 10+ singur", prep: ["caiet", "acces la aparatele din casă"], steps: ["Mergi prin casă", "Identifică folosirea inutilă a energiei", "Propune îmbunătățiri"] }
    },
    roLarge: {
      "tree-planting-explorer": { title: "Exploratorul Plantării de Copaci", achievement: "Pornitor de Rădăcini", summary: "Plantează copaci pentru a îmbunătăți biodiversitatea și spațiile verzi.", purpose: "Plantează copaci pentru a îmbunătăți biodiversitatea și spațiile verzi.", validation: "Trimite o poză cu copacii plantați și cu activitatea de plantare.", age: "6+ cu ajutor / 10+ singur", prep: ["lopată", "mănuși", "apă", "copac tânăr sau puiet"], steps: ["Găsește un eveniment de plantare sau un loc potrivit pentru plantare.", "Sapă groapa pentru plantare.", "Plantează copacul corect.", "Udă copacul după plantare."] },
      "car-free-explorer-day": { title: "Ziua Exploratorului Fără Mașină", achievement: "Înlocuitor de Drumuri", summary: "Petrece o zi înlocuind drumurile cu mașina prin mers pe jos, bicicletă sau transport public.", purpose: "Redu poluarea înlocuind drumurile cu mașina prin mers pe jos, bicicletă sau transport public.", validation: "Trimite poze care arată trei drumuri făcute fără mașină.", age: "8+ cu ajutor / 14-18 singur, în funcție de părinți", prep: ["bicicletă, pantofi de mers sau transport public"], steps: ["Planifică o zi fără să folosești mașina.", "Fă cel puțin trei drumuri fără mașină."] },
      "neighbourhood-cleanup-investigators": { title: "Investigatorii Curățeniei din Cartier", achievement: "Vânător de Indicii despre Gunoi", summary: "Curăță o zonă publică și investighează de ce apare gunoiul acolo.", purpose: "Curăță o zonă publică și investighează de ce apare gunoiul acolo.", validation: "Trimite o poză cu zona curățată și o scurtă explicație despre cauza apariției gunoiului.", age: "8+ cu ajutor / 12+ singur", prep: ["mănuși", "saci de gunoi", "telefon sau caiet"], steps: ["Curăță o zonă cu gunoi sau parcul tău local preferat.", "Observă unde apare gunoiul cel mai des.", "Identifică cauza probabilă a apariției gunoiului.", "Fă o îmbunătățire care să reducă problema."] },
      "repair-cafe-apprentice": { title: "Ucenicul Cafenelei de Reparații", achievement: "Învățăcel de Atelier", summary: "Învață abilități de reparat și prelungește viața obiectelor.", purpose: "Învață abilități de reparat și prelungește viața obiectelor.", validation: "Trimite o poză cu obiectul înainte și după reparație.", age: "10+ cu ajutor / 14+ singur", prep: ["obiect stricat", "unelte de reparat sau acces la un atelier de reparații"], steps: ["Vizitează un repair cafe sau un atelier de reparații.", "Lucrează cu cineva experimentat pentru a repara obiectul.", "Finalizează reparația."] },
      "little-animal-architect": { title: "Micul Arhitect al Animalelor", achievement: "Constructor de Habitat", summary: "Construiește un adăpost sau un suport de hrănire pentru animale mici.", purpose: "Construiește un adăpost sau un suport de hrănire pentru animale mici.", validation: "Trimite o poză cu structura finalizată, instalată afară.", age: "8+ cu ajutor / 12+ singur", prep: ["căsuță de păsări, hrănitoare pentru veverițe sau hotel pentru insecte", "lemn sau materiale reciclate", "șuruburi sau lipici", "unelte de bază"], steps: ["Construiește adăpostul sau hrănitoarea.", "Instalează-l în siguranță afară."] },
      "wild-meadow-starter": { title: "Pornitorul Pajiștii Sălbatice", achievement: "Ghid pentru Polenizatori", summary: "Creează o pajiște temporară cu flori sălbatice pentru polenizatori.", purpose: "Creează o pajiște temporară cu flori sălbatice pentru polenizatori.", validation: "Trimite o poză cu terenul înainte de plantare și cu zona plantată.", age: "6+ cu ajutor / 10+ singur", prep: ["semințe de flori sălbatice", "greblă sau lopată", "apă"], steps: ["Găsește un teren nefolosit, potrivit pentru plantare.", "Obține permisiune dacă este nevoie.", "Pregătește solul.", "Împrăștie semințele de flori sălbatice.", "Udă zona."] },
      "community-swap-day-organizer": { title: "Organizatorul Zilei de Schimb din Comunitate", achievement: "Gazdă de comori refolosite", summary: "Încurajează refolosirea organizând un eveniment de schimb.", purpose: "Încurajează refolosirea organizând un eveniment de schimb.", validation: "Trimite o poză de la evenimentul de schimb.", age: "12+ cu ajutor / 16+ singur", prep: ["masă sau spațiu comun", "obiecte pentru schimb", "participanți"], steps: ["Alege o locație.", "Invită participanții să aducă obiecte.", "Organizează obiectele pe categorii.", "Desfășoară evenimentul de schimb."] },
      "river-or-beach-guardian": { title: "Gardianul Râului sau al Plajei", achievement: "Salvator de Maluri", summary: "Îndepărtează deșeurile din râuri, lacuri sau de pe plaje.", purpose: "Îndepărtează deșeurile din râuri, lacuri sau de pe plaje.", validation: "Trimite o poză cu deșeurile colectate.", age: "8+ cu ajutor / 12+ singur", prep: ["mănuși", "saci de gunoi", "protecție solară"], steps: ["Alege o zonă de râu, lac sau plajă.", "Colectează gunoiul în siguranță.", "Aruncă deșeurile colectate în mod corect."] },
      "food-rescue-helper": { title: "Ajutorul Salvării de Mâncare", achievement: "Protector al mâncării", summary: "Redu risipa alimentară ajutând la redistribuirea alimentelor.", purpose: "Redu risipa alimentară ajutând la redistribuirea alimentelor.", validation: "Trimite o poză cu participarea la salvarea sau distribuirea alimentelor.", age: "10+ cu ajutor / 14+ singur", prep: ["sacoșe sau recipiente reutilizabile"], steps: ["Alătură-te unui grup de salvare a alimentelor sau unei activități de tip food bank.", "Ajută la sortarea sau distribuirea alimentelor."] },
      "school-sustainability-starter": { title: "Primul pas pentru o școală mai verde", achievement: "Scânteia schimbării", summary: "Pornește o îmbunătățire de sustenabilitate în școală.", purpose: "Pornește o îmbunătățire de sustenabilitate în școală.", validation: "Trimite o poză cu schimbarea sau o poza cu planul inițiativei.", age: "12+", prep: ["idee de îmbunătățire", "discuție cu un profesor sau membru al personalului"], steps: ["Identifică o îmbunătățire de sustenabilitate pentru școală.", "Discut-o cu un profesor sau cu un membru al personalului.", "Fă o îmbunătățire concretă."] },
      "planet-mission-scout": { title: "Cercetașul Misiunilor pentru Planetă", achievement: "Căutător de Trasee ONG", summary: "Participă la o activitate de mediu organizată de un ONG.", purpose: "Participă la o activitate de mediu organizată de un ONG.", validation: "Trimite o poză de la activitate.", age: "10+ cu ajutor / 14+ singur", prep: ["găsește un eveniment local de mediu"], steps: ["Găsește o activitate de mediu organizată de un ONG.", "Participă la activitate."] },
      "energy-provider-investigator": { title: "Investigatorul Furnizorului de Energie", achievement: "Explorator de energie", summary: "Cercetează furnizorul de electricitate al casei și explorează opțiuni regenerabile.", purpose: "Cercetează furnizorul de electricitate al casei și explorează opțiuni regenerabile.", validation: "Trimite o poza cu furnizorul actual și o poza cu opțiunile regenerabile sau cu mesajul trimis furnizorului.", age: "12+ cu ajutor / 15+ singur", prep: ["factură de electricitate", "acces la internet"], steps: ["Identifică furnizorul tău de electricitate.", "Cercetează opțiunile de energie regenerabilă.", "Dacă există, explorează schimbarea furnizorului.", "Dacă nu există, contactează furnizorul și cere opțiuni regenerabile."] }
    }
  };
