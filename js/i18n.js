...
const I18n = {
  ...
  translations: {
    ...
    ro: {
      ...
      'overview.diff.action.title': "Patch Coins",
      'overview.diff.action.text': "Le câștigi și le folosești. Acum în Market Hut, iar mai târziu pentru a debloca jocuri.",
      ...
      'overview.how.step1.text': "Adulții fac setările importante pentru copii",
      'overview.how.step2.title': "Alegi misiuni din Cartierul Misiunilor",
      'overview.how.step2.text': "Alegi misiuni potrivite timpului și abilităților tale",
      'overview.how.step3.title': "Faci misiuni într-un Trib",
      'overview.how.step3.text': "Un spațiu de echipă sigur, unde acționați împreună",
      ...
      'overview.how.step5.text': "Înveți despre pericole, observi probleme locale și descoperi echipe care ajută",
      ...
      'mvp.pillar4.text': "O lume de învățare și acțiune construită pas cu pas în Cluj, cu trei uși: My Hazards, Zona de Contaminare și Refacere, și Learn & Play, toate conectate la misiuni.",
      ...
      'tribes.next2': "Împărtășire mai bună a misiunilor prin căutare și favorite în Mission Shelf.",
      'tribes.next3': "Provocări opționale pe zone pentru Triburi (lunare sau sezoniere, fără să fie copleșitoare).",
      'tribes.next4': "Unelte mai bune pentru moderare și rapoarte de littering mai clare.",
      ...
      'market-hut.next1': "Licitație politicoasă opțională cu Patch Coins pentru produse foarte căutate (simplu și sigur pentru copii).",
      ...
      'earth-side.desc': "<p>Povestea Pământului este lumea de învățare și acțiune care pornește în Cluj Napoca și leagă învățarea de misiuni. Are trei uși:</p><ol><li>Pericolele Mele: explică simplu pericolele naturale, pericolele naturale agravate de poluare sau schimbări făcute de oameni și pericolele cauzate direct de oameni. Mini-lecturi și quiz-uri pot da Monede Patch.</li><li>Zona de Mizerie și Reparare (Harta Clujului): adulții (și adolescenții mai mari, unde e potrivit) pot pune un pin cu poză și notiță pentru gunoaie, lucruri stricate și zone care au nevoie de grijă. Pinii pot deveni misiuni.</li><li>Învață și Joacă: învățare scurtă, conectată la misiuni și monede.</li></ol><p>Mai târziu, apar și pini ajutători verificați:</p><ul><li>Ajutori (ONG-uri, cercetători, grupuri)</li><li>Misiuni (moduri de a ajuta)</li><li>Raportări (lucruri care au nevoie de atenție)</li></ul>",
      ...
      'games-room.desc': "<p>Camera Jocurilor este un modul de mai târziu care adună la un loc jocuri de încredere, care te învață despre natură fără să pară teme.</p><p>Patch Coins deschid jocurile (regula simplă: monedele deschid uși).</p><p>Și adulții pot juca și pot câștiga Patch Coins.</p>",
