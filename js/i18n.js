...
const I18n = {
  ...
  translations: {
    en: {
      ...
      'tribes.desc': '<p>A Tribe is EarthPatchers’ word for a small team (like a club). Tribes can be:</p><ul><li>Kids/Teens Tribes (aliases + avatars, no visible kids’ faces, kid activity visible only in the Tribe)</li><li>Adults-only Tribes (adults choose their visibility)</li></ul><p>Missions can be shared across Tribes so great missions spread without exposing children’s accounts.</p><p>Tribe “camp rules” keep things kind and clean:</p><ul><li>Be kind</li><li>Keep private details private</li><li>No visible kids’ faces</li><li>Don’t post littering (and don’t encourage it)</li><li>Use a Littering report when something shouldn’t be there</li></ul>',
