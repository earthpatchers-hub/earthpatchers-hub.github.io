...
const I18n = {
  ...
  translations: {
    en: {
      // Navigation
      'nav.overview': 'What We Are Trying to Fix',
      'nav.mvp': 'Base Camp',
      ...
      'hero.subtitle': 'Between work, school, laundry, and remembering where you left your keys, searching for trusted planet missions shouldn’t be another task on the list.<br><br>EarthPatchers aims to gather them in one place. Creating your own Tribe (group), starting your own mission, jumping into one started by others, or teaming up with one created by our trusted NGO partners is what we plan to start building first.',
      'hero.cta.mvp': 'See Base Camp',
      'hero.cta.donate': 'Donate Interest',
      'hero.cta.modules': 'Browse Modules',

      'overview.problem.title': 'What is EarthPatchers planning to fix',
      ...
      'overview.mission.small.examples': '<ul><li>Kids: water one local tree or plant and track it for a week.</li><li>Teens: take one no-car day and use bike, bus, or walking.</li><li data-audience="public">Adults: donate one item you no longer use (for example a toy, book, or jacket).</li><li data-audience="partners">Adults: add one item you no longer use to Market Hut (for example a toy, book, or jacket).</li></ul>',
      ...
      'overview.tribe.text': 'A Tribe is a small team.<br>Not a crowd. Not a stadium. A handful of people saying, “Let’s do this together.”<br>The kind of team where you know who brings snacks and who always forgets socks.<br>Like a camp club, but for real life.',
      ...
      'overview.how.table.step4.adult': 'Patch Coins will be earned after validation.',
      ...
      // MVP Page
      'mvp.title': 'Base Camp',
      'mvp.title.public': 'Base Camp',
      'mvp.title.plan': '36-Month Plan',
      'mvp.intro.public': 'EarthPatchers starts with a focused plan in Cluj and begins with two core pillars:',
      ...
      'mvp.public.more.title': 'Want to see everything we plan next?',
      'mvp.public.more.text': 'Switch to Partner View to explore the full Base Camp plan and Next Steps in our Adventure.',
      'mvp.public.more.cta': 'Go to Partner View',
      ...
      'contact.intro': 'If you want to start missions or get involved as a teacher, parent, scout leader, NGO, or partner, email us directly and we will guide you.',
      ...
      'donate.status.error': 'Could not send right now. Please use the email button above.',
    ...
    ro: {
      ...
      'hero.subtitle': "Între serviciu, școală, rufe de spălat și veșnica întrebare „unde mi-am pus cheile?”, căutarea unor misiuni de încredere pentru planetă n-ar trebui să mai fie încă o sarcină pe listă.<br><br>EarthPatchers își propune să le adune într-un singur loc. Vei putea să-ți creezi propriul Trib (grup), să pornești propria misiune, să te alături uneia deja începute sau să te alături uneia create de partenerii noștri ONG de încredere.",
      'hero.cta.mvp': "Vezi Tabăra de Bază",
      'hero.cta.donate': "Interes pentru donație",
      'hero.cta.modules': "Vezi modulele",

      'overview.problem.title': "Ce își propune EarthPatchers să repare",
      ...
      'overview.problem.solution': "Fără stress. Fără griji.<br>Doar acțiune practică, efort împărtășit și reamintirea că lucrurile mari nu se repară de unul singur.<br><br><span class=\"overview-problem-signoff\">Reparăm Pământul împreună — cusătură cu cusătură.</span>",
      ...
      'overview.mission.small.examples': "<ul><li>Copii: udă un copac sau o plantă din apropiere și urmăresc evoluția timp de o săptămână.</li><li>Adolescenți: aleg o zi fără mașină și merg cu bicicleta, autobuzul sau pe jos.</li><li data-audience=\"public\">Adulți: donează un obiect pe care nu îl mai folosesc (de exemplu o jucărie, o carte sau o geacă).</li><li data-audience=\"partners\">Adulți: adaugă în Căsuța de Schimb un obiect pe care nu îl mai folosesc (de exemplu o jucărie, o carte sau o geacă).</li></ul>",
      ...
      'overview.tribe.text': "Un Trib este o echipă mică.<br>Nu o mulțime. Nu un stadion. O mână de oameni care spun: „Hai să facem asta împreună.”<br>Genul de echipă în care știi cine aduce gustările și cine uită mereu șosetele.<br>Ca un club de tabără, dar pentru viața reală.",
      ...
      'overview.how.table.step4.adult': 'Monedele Patch se vor câștiga după validare.',
      ...
      'mvp.title.public': "Tabăra de Bază",
      'mvp.title.plan': "plan pe 36 de luni",
      'mvp.intro.public': "EarthPatchers începe cu un plan concentrat în Cluj și pornește cu doi piloni de bază:",
      ...
      'mvp.public.more.title': "Vrei să vezi tot ce urmează să construim?",
      'mvp.public.more.text': "Treci în Partner View ca să explorezi planul complet din Tabăra de Bază și pașii următori din aventura noastră.",
      'mvp.public.more.cta': "Mergi la Partner View",
      ...
      'contact.intro': 'Dacă vrei să începi misiuni sau să te implici ca profesor, părinte, lider de cercetași, ONG sau partener, scrie-ne direct pe email și te ghidăm mai departe.',
      ...
      'donate.status.error': 'Nu s-a putut trimite acum. Te rog folosește butonul de email de mai sus.',
